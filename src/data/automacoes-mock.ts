...
export const automacoesMock: Automacao[] = [
  {
    ...
    nodes: [
      { id: 'n1', type: 'new_lead', position: { x: 50, y: 200 } },
      { id: 'n2', type: 'run_ai_agent', position: { x: 320, y: 200 } },
      { id: 'n3', type: 'send_whatsapp', position: { x: 590, y: 200 } },
      { id: 'n4', type: 'wait', position: { x: 860, y: 200 }, config: { amount: 30, unit: 'minutos' } },
      { id: 'n5', type: 'send_email', position: { x: 1130, y: 200 } },
    ],
    edges: [
  ...
  },
  {
    ...
    nodes: [
      { id: 'n1', type: 'tag_added', position: { x: 50, y: 200 } },
      { id: 'n2', type: 'send_whatsapp', position: { x: 320, y: 200 } },
      { id: 'n3', type: 'wait', position: { x: 590, y: 200 }, config: { amount: 3, unit: 'dias' } },
      { id: 'n4', type: 'condition', position: { x: 860, y: 200 } },
      { id: 'n5', type: 'move_pipeline', position: { x: 1130, y: 100 } },
      { id: 'n6', type: 'send_email', position: { x: 1130, y: 320 } },
    ],
    edges: [
      { id: 'e1', source: 'n1', target: 'n2' },
      { id: 'e2', source: 'n2', target: 'n3' },
  ...
  },
  {
    ...
    nodes: [
      { id: 'n1', type: 'purchase', position: { x: 50, y: 200 } },
      { id: 'n2', type: 'send_email', position: { x: 320, y: 200 } },
      { id: 'n3', type: 'wait', position: { x: 590, y: 200 }, config: { amount: 2, unit: 'dias' } },
      { id: 'n4', type: 'send_email', position: { x: 860, y: 200 } },
      { id: 'n5', type: 'add_tag', position: { x: 1130, y: 200 } },
    ],
    edges: [
      { id: 'e1', source: 'n1', target: 'n2' },
      { id: 'e2', source: 'n2', target: 'n3' },
...
export const templatesMock: TemplateAutomacao[] = [
  {
    ...
    nodes: [
      ...
      { id: 'n2', type: 'run_ai_agent', position: { x: 320, y: 200 } },
      { id: 'n3', type: 'send_whatsapp', position: { x: 590, y: 200 } },
      { id: 'n4', type: 'wait', position: { x: 860, y: 200 }, config: { amount: 1, unit: 'horas' } },
      { id: 'n5', type: 'send_email', position: { x: 1130, y: 200 } },
    ],
    edges: [
      { id: 'e1', source: 'n1', target: 'n2' },
  ...
  },
  {
    ...
    nodes: [
      { id: 'n1', type: 'new_lead', position: { x: 50, y: 200 } },
      { id: 'n2', type: 'run_ai_agent', position: { x: 320, y: 200 } },
      { id: 'n3', type: 'condition', position: { x: 590, y: 200 } },
      { id: 'n4', type: 'create_task', position: { x: 860, y: 100 } },
      { id: 'n5', type: 'move_pipeline', position: { x: 1130, y: 100 } },
      { id: 'n6', type: 'end', position: { x: 860, y: 320 } },
    ],
    edges: [
      { id: 'e1', source: 'n1', target: 'n2' },
      { id: 'e2', source: 'n2', target: 'n3' },
  ...
  },
  {
    ...
    tags: ['WhatsApp', 'Email'],
    nodes: [
      { id: 'n1', type: 'webhook', position: { x: 50, y: 200 } },
      { id: 'n2', type: 'wait', position: { x: 320, y: 200 }, config: { amount: 30, unit: 'minutos' } },
      { id: 'n3', type: 'condition', position: { x: 590, y: 200 } },
      { id: 'n4', type: 'send_whatsapp', position: { x: 860, y: 100 } },
      { id: 'n5', type: 'send_email', position: { x: 1130, y: 100 } },
      { id: 'n6', type: 'end', position: { x: 860, y: 320 } },
    ],
    edges: [
      { id: 'e1', source: 'n1', target: 'n2' },
  ...
  },
  {
    ...
    tags: ['Email', 'CRM'],
    nodes: [
      { id: 'n1', type: 'schedule', position: { x: 50, y: 200 } },
      { id: 'n2', type: 'check_tag', position: { x: 320, y: 200 } },
      { id: 'n3', type: 'send_email', position: { x: 590, y: 200 } },
    ],
    edges: [
      { id: 'e1', source: 'n1', target: 'n2' },
      { id: 'e2', source: 'n2', target: 'n3' },
